...
export function AdminShell({
  ...
  return (
    <div className="flex min-h-screen surface-sunken">
      {/* ---- Sidebar (desktop) ------------------------------------------ */}
      <aside className="hidden w-64 shrink-0 flex-col border-r border-[var(--border-subtle)] surface-raised lg:flex">
  ...
  return (
    <div className="border-t border-[var(--border-subtle)] p-3">
      ...
      <form action={logout}>
        <button
          type="submit"
          className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-[var(--text-secondary)] transition-colors hover:bg-[var(--surface-sunken)] hover:text-[var(--text-primary)]"
        >
