...
export default function AboutPage() {
  ...
  return (
    <MarketingShell>
      <Helmet>
        <title>About — SingAdvisor</title>
        <meta
          name="description"
          content="SingAdvisor is a Singapore learning and consultancy practice working with students, corporate teams and professionals since 2016."
        />
      </Helmet>
