...
// forwardRef: React 19 (the Next app's version) passes ref as a normal prop,
// React 18 (this SPA) requires forwardRef for function components to receive
// one — LoginForm and the demo-fill logic attach refs to these inputs.
