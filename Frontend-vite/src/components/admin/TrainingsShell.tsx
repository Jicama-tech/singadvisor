 ...
 * sidebar (Courses, Facilitators, Content, Participants). Unlike the Events
 * section, every page under /admin/trainings wears this — including the
 * new/edit forms — so the nested nav never flickers out mid-section. The
 * primary sidebar collapses to icons on these routes (see AdminShell's
