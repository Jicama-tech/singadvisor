// Copied from eventsh-v1/frontend/src/data/countries.ts (2026-08-18) so the
// country-code dropdowns in both apps share one source of truth. Flag strings
// are empty in the source data — the dropdowns show "Name (+dial)" instead.
