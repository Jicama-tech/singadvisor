...
export const metadata: Metadata = {
  title: "Consultancy",
  description:
    "Learning strategy, leadership pipeline design, team effectiveness diagnostics and workplace wellbeing consultancy for organisations in Singapore.",
};
      ...
      <Section id="services">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {services.map((service) => {
            ...
            return (
              <Card key={service.id} interactive className="h-full">
